...
export default function Home() {
  ...
  return (
    <div
      className="bg-black w-screen h-screen flex flex-col overflow-hidden "
    >
      {/* NavBar display */}
      {<Nav showModal={setshowModal} setArr={setArr} />}
      ...
      style={{
        ...
        {arr.length !== 0 && (
          <div className="w-full flex-1 overflow-y-auto  p-4 scrollbar overflow-x-hidden">
            {arr.map((e, i) => {
              if (e.type === 0) {
                return (
                  <DisplayText key={i} index={i} data={e} setarr={setArr} />
                );
              } else {
                return (
